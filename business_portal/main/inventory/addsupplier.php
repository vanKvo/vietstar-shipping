...
<span>Contact Person : </span><input type="text" style="width:265px; height:30px;" name="contact" required/><br>
<span>Contact No. : </span><input type="text" style="width:265px; height:30px;" name="cperson" required/><br>
<span>Note : </span><textarea style="width:265px; height:80px;" name="note" required></textarea><br>
