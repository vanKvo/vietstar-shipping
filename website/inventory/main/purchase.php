...
<a rel="facebox" href="addpurchase.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Purchase</button></a><br><br>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="17%"> Scan UPC </th>
			<th width="10%"> Supplier's Name</th>
			<th width="10%"> Cost of Product</th>
			<th width="23%"> Quantity of Product</th>
			<th width="14%"> Action </th>
