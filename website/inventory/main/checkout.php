...
<input type="text" size="25" value="" name="ptype" class="greybox" onblur="fill();" class="" autocomplete="off" placeholder="Cash/ Credit" style="width: 268px; height:30px;" required/>
